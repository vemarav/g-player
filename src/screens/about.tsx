      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.listContainer}>
        <View style={styles.itemContainer}>
          ...
          <Text style={styles.subtitle}>
            ...
            the Privacy Policy which forms an integral part of the User Agreement between G Player
            and you (“User”, “You” or “Your”) in relation to Your access to use of the Services. .
            The Service shall also mean and include the Subscription Service (as defined hereunder),
            by User. {'\n\n'}
